...
\hypertarget{wave-plot}{%
\section{Wave plot}\label{wave-plot}}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{plot}\NormalTok{(sin\_df)}
\end{Highlighting}
\end{Shaded}

\includegraphics{Assignment1Notebook_files/figure-latex/unnamed-chunk-1-1.pdf}
\# Displaying mathematical formulae \(y=\sin(x)\)

{[}
\sin(x)=\sum\_\{n=1\}\textsuperscript{\{\infty\}(-1)}\{n+1\}\cdot \frac{x^{2n-1}}{(2n-1)!}
